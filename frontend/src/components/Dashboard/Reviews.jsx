  ...
  const fetchReviews = async () => {
    try {
      const response = await axios.get(
        `http://localhost:8000/api/v1/reviews/get-user-reviews?page=${page}&sortBy=${sortBy}&sortType=${sortType}`,
        {
  ...
  const updateReview = async (reviewId) => {
    ...
    try {
      const response = await axios.put(
        'http://localhost:8000/api/v1/reviews/update-review/${reviewId}',
        formData,
        {
          withCredentials: true,
        }
  ...
  const deleteReview = async (reviewId) => {
    try {
      const response = await axios.delete(
        'http://localhost:8000/api/v1/reviews/delete-review/${reviewId}',
        {
          withCredentials: true,
        }
      );
