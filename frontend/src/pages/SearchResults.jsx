    ...
    <div className="container mx-auto py-8">
      <div className="flex">
        <aside className="w-1/5 pr-4 ">
          <h2 className="text-2xl text-center font-bold mb-4 mr-3">FILTERS</h2>
          <hr className="mb-4" />
          <div className="mb-4">
            <label className="text-xl block mb-2">Price Range</label>
            <Slider
              range
              min={0}
              max={100000}
              ...
              value={priceRange}
            />
            <div className="text-l flex justify-between mt-2">
